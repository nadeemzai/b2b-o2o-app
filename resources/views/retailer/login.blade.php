...
<div class="w-full max-w-md">
    ...
    <div class="text-center mb-8">
        <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-brand mb-4">
        ...
        <form action="{{ route('retailer.login.post') }}" method="POST" class="space-y-5">
            ...
            <div class="flex items-center justify-between">
                <label class="flex items-center gap-2 text-sm text-zinc-600 dark:text-zinc-400">
                    <input type="checkbox" name="remember" class="rounded border-zinc-300 dark:border-zinc-600 text-brand">
                    Remember me
                </label>
            </div>
